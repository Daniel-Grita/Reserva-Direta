...
export default function SolucaoFeatures() {
  ...
  return (
    <section ref={ref} data-reveal={inView} id="funcionalidades" className="bg-white py-section-y">
        ...
        <div className="reveal-stagger grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {bookingSystem.features.cards.map((card, i) => (
            ...
            >
              ...
              <h3 className="text-card-title font-display text-navy mb-2">{card.title}</h3>
